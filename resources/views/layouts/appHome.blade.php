...
<head>
    ...
    <title>{{ config('app.name', 'Energy Theft Demo') }}</title>
...
<body class="container-login100"
    style="background-image: url('images/bg-01.jpg'); background-repeat: no-repeat; background-position: center; background-size: cover;">
    <div id="app">
